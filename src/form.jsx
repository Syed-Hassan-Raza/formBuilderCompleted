  ...
  render() {
    ...
    const items = data_items.map(item => {
      ...
      switch (item.element) {
        ...
        case 'Signature':
          return <Signature ref={c => this.inputs[item.field_name] = c} ReadOnly={this.props.ReadOnly || item.readOnly} mutable={true} key={`form_${item.id}`} data={item} defaultValue={this._getDefaultValue(item)} />;
        case 'Checkboxes':
          return <Checkboxes ref={c => this.inputs[item.field_name] = c} ReadOnly={this.props.ReadOnly} handleChange={this.handleChange} mutable={true} key={`form_${item.id}`} data={item} defaultValue={this._optionsDefaultValue(item)} />;
        case 'Image':
        ...
        case 'Camera':
          return <Camera ref={c => this.inputs[item.field_name] = c} ReadOnly={this.props.ReadOnly || item.readOnly} mutable={true} key={`form_${item.id}`} data={item} defaultValue={this._getDefaultValue(item)} />;
        default:
