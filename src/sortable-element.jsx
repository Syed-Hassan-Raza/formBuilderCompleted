...
export default function (ComposedComponent) {
  ...
  class Card extends Component {
    ...
    render() {
      ...
      let isFieldGroup = this.props.data
        ? this.props.data.element === "FieldGroups"
        : false;
      ...
      return connectDragSource(
        connectDropTarget(
          <div
            style={{
              width:
                (this.props.id == "form-place-holder"
                  ? 1
                  : this.props.data.ControlWidthRatio || 1) *
                  100 +
                "%",
              margin: "10px 0px",
            }}
          >
            {hrShow && (
              <>
                <hr id="hrSeprater" style={hrStyle} />
                {isFieldGroup && (
                  <span className="text-danger blink">
                    {"Dragging inside "}
                    {this.props.data ? this.props.data.Label : "main container"}
                  </span>
                )}
              </>
            )}
